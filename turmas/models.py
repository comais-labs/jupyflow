...
class ContainerTurma(models.Model):
    nome_container = models.CharField(
        "Tag do Container", max_length=20, null=False, unique=True
    )
    ...
    mensagem_erro = models.TextField("Mensagem de Erro", null=True)
...
class UltimaPorta(models.Model):
    ultima_porta = models.CharField("Ultima porta", max_length=6, null=False)
